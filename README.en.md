...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3000&pause=1000&color=2196F3&center=true&vCenter=true&width=500&lines=Building+Beautiful+Interfaces;TypeScript+%2B+Angular+Expert;Clean+Code+Enthusiast)](https://github.com/MihaelaAghirculesei)
...
[![Email](https://img.shields.io/badge/Email-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:kontakt@mihaela-melania-aghirculesei.de)
![Visitors](https://visitor-badge.laobi.icu/badge?page_id=MihaelaAghirculesei)
...
I'm a frontend developer passionate about creating intuitive, performant user interfaces. I specialize in building scalable Angular applications with clean, maintainable code.
...
const mihaela = {
  ...
  currentFocus: "Advanced Angular patterns & UI/UX design",
...
An action-packed 2D jump-and-run game featuring Pepe as the main character. Collect coins and bottles, defeat enemies, and master challenging levels in this exciting adventure.
...
A modern, web-based Pokédex with comprehensive PokéAPI integration. The application provides an intuitive and interactive experience for Pokémon fans.

**Tech:** Vanilla JavaScript ES6+ • PWA architecture • RESTful API integration • Performance optimization • Accessibility-first design
...
- 🔨 **Working on:** [Birthday Memories](https://github.com/MihaelaAghirculesei/birthday-reminder-app)
- 📚 **Proficient in:** NGRX (store, effects, selectors), Facade pattern, Angular Signals, offline-first architecture with IndexedDB, testing (unit/e2e), PWA with Service Worker, OAuth 2.0
- 💼 **Open to:** Frontend Developer roles (Angular/TypeScript focus)
- 💬 **Ask me about:** Angular 19, NGRX, TypeScript, RxJS, Angular Signals, PWA, testing with Jasmine/Cypress
...
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-Visit_My_Website-FF5722?style=for-the-badge)](https://mihaela-melania-aghirculesei.de/)
