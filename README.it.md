...
CLI che analizza un intero sito web per violazioni WCAG 2.1 AA e mappa ogni riscontro alla clausola EN 301 549 / BFSG che infrange – producendo un report di conformità citabile in JSON/HTML/PDF. Costruito in 28 pull request revisionate singolarmente; le decisioni architetturali chiave sono documentate in otto ADR.
...
- **Supply chain:** pubblicato su npm con SLSA build provenance tramite OIDC trusted publishing – nessun token a lunga durata
